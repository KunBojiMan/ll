...
export default class AddToCardPluginPlugin extends AddToCardPlugin {
    ...
    _openOffCanvasCart(instance,requestUrl, formData)  {
        this._client.post(requestUrl, formData, this. afterAddItemToCard.bind(this))
    }
    ...
    _refreshCartValue() {
        ...
        const cartWidgetInstance = this.PluginManger.getPluginIntancefromElement(cartWidgetEl, 'CartWidget')
